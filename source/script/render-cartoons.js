...
document.addEventListener('DOMContentLoaded', () => {
    ...
    /**
     * Создаёт HTML-элемент карточки фильма/сериала сразу с заглушкой
     */
    function createCardAndObserve(movie) {
        ...
        // Логика добавления бейджа TV из второго кода
        const tvBadge = movie.isTV === true ? `<div class="card-TV">TV</div>` : '';
